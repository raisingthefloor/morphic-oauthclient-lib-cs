...
namespace Morphic.OAuth.Utils
{
    internal struct EncodingUtils
    {
        ...
        internal static string EncodeUsernameAndPasswordForOAuthBasicAuthorization(string username, string password)
        {
        ...
        internal static bool VerifyContentTypeIsApplicationJson(string contentType)
        {
